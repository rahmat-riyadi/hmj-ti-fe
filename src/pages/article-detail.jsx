...
const ArticleDetail = () => {
    ...
    return (
        <Box display='flex' alignItems='center' flexDirection='column'>
            <Box width='69.5%'>
                <Typography fontWeight={700} fontSize={28} textAlign='center'>Rapat Kerja HMJ-TI Periode 2023-2024</Typography>
                <Box component='img' src={detailPic} width='100%' />
                <Typography fontStyle='italic'>Dipublikasikan pada 17-November-2023</Typography>
